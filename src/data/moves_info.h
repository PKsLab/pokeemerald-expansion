...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] = 
{
    ...
    [MOVE_ICE_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "An icy punch that has\n"
        #if B_USE_FROSTBITE == TRUE
            "leave the foe with frostbite."),
        #else
            "a 1/10 chance to freeze."),
        #endif
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ICE,
    ...
    [MOVE_THUNDER_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "An electric punch that has a\n"
            "1/10 chance to paralyze."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_VISE_GRIP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Grips the foe with strong\n"
            "pincers for 3-5 turns."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_FLY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Soars and strikes in 2 turns.\n"
            "Always boosts accuracy by 1."),
        .effect = EFFECT_SEMI_INVULNERABLE,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 95 : 95,
        .type = TYPE_FLYING,
        .accuracy = 0,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_VINE_WHIP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes the foe with 2\n"
            "vines. Each hit lowers Def."),
    ...
    [MOVE_DOUBLE_KICK] =
    {
        ...
        .description = COMPOUND_STRING(
            "Kicks the foe twice. Each hit\n"
            "has a 1/7 chance to flinch."),
        .effect = EFFECT_HIT,
        .power = 35,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_BODY_SLAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A full-body slam on the\n"
            "target. 1/3 to paralyze."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_TAKE_DOWN] =
    {
        ...
        .description = COMPOUND_STRING(
            "A charging attack. 1/5\n"
            "recoil and 1/3 to lower Def."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_THRASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A boisterous attack for\n"
            "2-3 turns. Confuses after."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_DOUBLE_EDGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A charging attack. 1/3\n"
            "recoil and 1/2 to lower Def."),
        .effect = EFFECT_HIT,
        .power = 125,
        .type = TYPE_NORMAL,
        .accuracy = 100,
